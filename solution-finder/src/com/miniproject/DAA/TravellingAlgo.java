...
public class TravellingAlgo {
	...
	static String result="The minimum cost is:";
	static String result1="Path taken is:";
    static int N;
    ...
    // the final solution 
    static void copyToFinal(int curr_path[]) throws Exception
    { 
        for (int i = 0; i < N; i++) 
    ...
    static int firstMin(int adj[][], int i) throws Exception
    { 
    ...
    // having an end at the vertex i 
    static int secondMin(int adj[][], int i) throws Exception
    { 
    ...
    static void TSPRec(int adj[][], int curr_bound, int curr_weight, 
                int level, int curr_path[]) throws Exception
    { 
    ...
    static String TSP(int adj[][]) throws Exception
    { 
        ...
        String answer=printAns(final_res,final_path);
        return answer;
}
...
/*	public static void main(String[] args) 
	...
	*/
    ...
    static String printAns(int final_res,int[] final_path)throws Exception{
    	 result=result+Integer.toString(final_res);
         for (int i = 0; i <= N; i++)  
         { 
             result1=result1+"<br>"+Integer.toString(final_path[i]);
         } 
         String answer =result+"<br>"+result1;
         return answer;
    }
}
