...
import com.miniproject.DAA.TravellingAlgo;

public class TspFrame {
	JFrame f;
	JButton ok;
	...
	public void Tsp(){
		   f = new JFrame("Travelling Salesmen prob using B and B");
		   ok = new JButton("ok"); // ok button
			...
			ok.addActionListener(new CustomTspAlgo());
			textfield.addKeyListener(new CustomKeyListener());
			//f.add(label1);
			f.add(label1);
			
	   }
	   class CustomTspAlgo implements ActionListener {
...
//			f.add(sourceField);
			...
			solve.addActionListener(new TspAlgorithm());

		}

		class  TspAlgorithm implements ActionListener {
			...
			public void actionPerformed(ActionEvent e) {
				...
				TravellingAlgo tspa=new TravellingAlgo();
				 String result = tspa.conversion(length , inputArray);
